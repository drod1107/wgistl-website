    ...
    <>
      <main className="flex-1 flex items-center justify-center relative m-5">
        <iframe 
          width="auto" 
          height="500" 
          src="https://www.youtube.com/embed/QYp_N8CoNM?s=PG_vGkfcWRHQxAEz" 
      ...
      <div className="bg-black bg-opacity-50 p-8 rounded-lg text-center relative z-10">
        ...
        <p className="text-xl text-white mt-4 font-montserrat">
          ...
          <strong>click the button below to learn what that looks like or to get started </strong><br/><br/> 
          Let’s <br/> <br/><strong>amplify your voice</strong><br/> <br/> and <br/> <br/><strong>deepen your impact.</strong><br/>
        </p>
